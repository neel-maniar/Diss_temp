...
def script_3D(params):
    ...
    for i in trange(N_REPEAT):
        ...
        ypred, y_std = predict(opt_posterior_diag, dataset_test.X, dataset_train)
        ...
        # ypred, y_std = predict(opt_posterior_curlfree, dataset_test.X, dataset_train)
        ...
        for j, N_c in enumerate(N_C_LIST):
            ...
            dataset_coll_train = add_collocation_points(
                dataset_train, test_pos, N_c, master_key
            )
