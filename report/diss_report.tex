...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{2DSimulationData}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{RMSE_2D}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{NLPD_2D}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{observed_path_3D_colours}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{RMSE_3D}
	\caption{RMSE aggregated over 50 runs. The mean is plotted in a solid line and 1 standard deviation is shaded.}
	\label{rmse3d}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{NLPD_3D}
	\caption{NLPD aggregated over 50 runs. The mean is plotted in a solid line and 1 standard deviation is shaded.}
	\label{nlpd3d}
\end{figure}
